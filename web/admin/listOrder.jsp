			...
			<tbody>
				<c:forEach items="${os }" var="o">
					<tr>
						...
						<td><fmt:formatDate type="date" pattern="yyyy-MM-dd HH:mm:ss" value="${o.createDate}"/></td>
						<td><fmt:formatDate type="date" pattern="yyyy-MM-dd HH:mm:ss" value="${o.payDate}"/></td>
						<td><fmt:formatDate type="date" pattern="yyyy-MM-dd HH:mm:ss" value="${o.deliveryDate}"/></td>
						<td><fmt:formatDate type="date" pattern="yyyy-MM-dd HH:mm:ss" value="${o.confirmDate}"/></td>
						<td>
